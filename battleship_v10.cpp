...
do{ //do while loop around everything, so game is capable of restarting when player prompts it to do so at end of game
    ...
    if (!coHit[0]&&plLet==coLet[0]&&plNum==coNum[0]) { //if else if statements to keep track of player's attacks, both hits and misses
     ...
     else if (!coHit[1]&&plLet==coLet[1]&&plNum==coNum[1]) {
            cout<<"You have hit one of your opponent's ships - and it sank!"<<endl<<endl;
     ...
     else if (!coHit[2]&&plLet==coLet[2]&&plNum==coNum[2])  {
            cout<<"You have hit one of your opponent's ships - and it sank!"<<endl<<endl;
            cout<<"Accuracy: "<<setw(6)<<fixed<<setprecision(1)<<atkAc<<"%"<<endl<<endl;
            cout<<"Enter a letter coordinate between K and T to launch a new attack."<<endl;
            coHit[2]=true;
     ...
     else if (!coHit[3]&&plLet==coLet[3]&&plNum==coNum[3])  {
            cout<<"You have hit one of your opponent's ships - and it sank!"<<endl<<endl;
            cout<<"Accuracy: "<<setw(6)<<fixed<<setprecision(1)<<atkAc<<"%"<<endl<<endl;
            cout<<"Enter a letter coordinate between K and T to launch a new attack."<<endl;
            coHit[3]=true;
     ...
     else if (!coHit[4]&&plLet==coLet[4]&&plNum==coNum[4])  {
            cout<<"You have hit one of your opponent's ships - and it sank!"<<endl<<endl;
            cout<<"Accuracy: "<<setw(6)<<fixed<<setprecision(1)<<atkAc<<"%"<<endl<<endl;
            coHit[4]=true;
            remShip--;
